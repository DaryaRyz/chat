...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/avito.png
  AssetGenImage get avito => const AssetGenImage('assets/icons/avito.png');
  ...
  /// File path: assets/icons/menu_dots.svg
  SvgGenImage get menuDots => const SvgGenImage('assets/icons/menu_dots.svg');
  ...
  /// File path: assets/icons/vkontakte.png
  AssetGenImage get vkontakte =>
      const AssetGenImage('assets/icons/vkontakte.png');

  /// File path: assets/icons/whats_app.png
  AssetGenImage get whatsApp =>
      const AssetGenImage('assets/icons/whats_app.png');
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [chatBackground];
}
